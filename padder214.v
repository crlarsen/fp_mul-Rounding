...
//
// Create Date: 03/23/2022 07:46:25 PM
// Design Name:
// Module Name: padder214
// Project Name:
// Target Devices:
// Tool Versions:
// Description: 214-bit Integer Prefix Adder with Carry In/Carry Out
//
...
module padder214(A, B, Cin, S, Cout);
  parameter N = 214;
  input [N-1:0] A, B;
  input Cin;
  output [N-1:0] S;
  ...
  assign Cout = (\G212:-1 & A[213]) | (\G212:-1 & B[213]) | (A[213] & B[213]);
