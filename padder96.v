...
//
// Create Date: 04/26/2021 03:18:43 PM
// Design Name:
// Module Name: padder96
// Project Name:
// Target Devices:
// Tool Versions:
// Description: 96-bit Integer Prefix Adder with Carry In/Carry Out
//
...
module padder96(A, B, Cin, S, Cout);
  parameter N = 96;
  input [N-1:0] A, B;
  input Cin;
  output [N-1:0] S;
  ...
  assign Cout = (\G94:-1 & A[95]) | (\G94:-1 & B[95]) | (A[95] & B[95]);
